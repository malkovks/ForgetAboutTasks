...
class UserProfileFooterView: UIView {
    ...
    func setupTextLabel(section: Int){
        ...
        case 1: footerLabel.text = "This include changing font size and style. Either you can change App Icon"
        case 2: footerLabel.text = "You could change localization of application, read information about developer and read some features, which planned on near future"
        default: break
        }
    }
